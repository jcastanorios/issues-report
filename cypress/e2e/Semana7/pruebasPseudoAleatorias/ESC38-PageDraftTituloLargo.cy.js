...
describe('Escenario #18 - Crear un post, y verificar que este publicado en borrador', () => {
    beforeEach(()=>{
     ...
     it('ESC112-Crear un nuevo page con titulo corto, Verificar que este en la lista de borrador- PseudoAleatorio', () => {
      //El titulo del page se corta a la logitud de los caracteres permitidos, pero no genera algun aviso
      let lista = []
      let elem = new Object()    
      ...
      .then((response) => {
          ...
          elem = lista[i]
          console.log("elemento desde la lista: nommbre= " +elem.titulo)    
          generarPage(elem.titulo)
      });        
    })
