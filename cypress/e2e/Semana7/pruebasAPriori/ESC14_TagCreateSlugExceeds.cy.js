...
const dataPrueba = require("./data/text190.json");
const dataPrueba1 = require("./data/text195.json");
...
describe("Escenario para validar y verificar la creación y la publicación de un tag en la aplicación ghost", () => {
    ...
    it("Cuarto caso: Crear tag, slug excede limite en Ghost...", () => {
        ...
        tituloTag = JSON.stringify(dataPrueba[indice].text_190).replace(/"/g, '');
        //slug
        indice1 = getRandom(0, dataPrueba1.length);
        slug = dataPrueba1[indice1];
        slug = JSON.stringify(dataPrueba1[indice1].text_195).replace(/"/g, '');
        //descripcion
