...
describe('Escenario #20 - Crear un tag, y asignarle a un page', () => {
    ...
    it('ESC118 - Crear un nuevo tag con nombre largo, Crear un nuevo page y asignarle el tag creado -PseudoAleatorio',() => {
        //Cuando el tag es muy largo no permite crerar, sale un mensaje de confirmación
        let lista = []
        let elem = new Object()    
        ...
        .then((response) => {
            ...
            generarTagAsigPage(elem.titulo, pageTitulo)
        });        
    })
});   
