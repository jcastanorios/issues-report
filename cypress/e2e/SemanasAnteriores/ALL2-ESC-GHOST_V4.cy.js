...
describe('Testing Ghost', () => {
    ...
    it('Crear y validar nuevo tag', () => {
        let nombreEscenario = "V4_ESC6_CreateTag"
        visitGhost("#/tags")
        cy.wait(2000)
    ...
    it('Editar tag y validar', () =>{
        let nombreEscenario = "V4_ESC7_EditTag"
    ...
    it('Crear, borrar tag y validar', () =>{
        let nombreEscenario = "V4_ESC8_DeleteTag"
        visitGhost("#/tags")
        cy.wait(3000)
        ScreenshotPage.takeScreenshot(nombreEscenario, `Tags`) 
        cy.get('a.ember-view.gh-btn.gh-btn-primary').click()  //click en New tag
    ...
    it('Unpublish un post', () =>{
        let nombreEscenario = "V4_ESC9_UnpublishPost"
    ...
    it('Crear draft de pages y publicarlo', () =>{
        let nombreEscenario = "V4_ESC10_CreateTag"
        cy.get('a[href="#/pages/"]').click()  // hacer click sobre pages
        cy.wait(1000)
        ScreenshotPage.takeScreenshot(nombreEscenario, `Pages`)
        cy.get('a[href="#/editor/page/"]').click()  //crear nuevo page
        cy.wait(1000)
        ScreenshotPage.takeScreenshot(nombreEscenario, `NewPages`)
        ...
        if(Constantes.VERSION_GHOST==5){ 
            ...
            visitGhost("#/pages?type=published"); // click en Pages para retornar a dashborad
        } 
        else if(Constantes.VERSION_GHOST==4){
            cy.get('div.ember-view.ember-basic-dropdown-trigger.gh-btn.gh-btn-editor.gh-publishmenu-trigger').click();//botón publish
            cy.wait(1000)
            ...
            ScreenshotPage.takeScreenshot(nombreEscenario, `ContinuePublishButton`)
            cy.get('button.gh-btn.gh-btn-black.gh-btn-icon.ember-view').click();//click en publicar de una vez
            visitGhost("#/pages?type=published")
        }
