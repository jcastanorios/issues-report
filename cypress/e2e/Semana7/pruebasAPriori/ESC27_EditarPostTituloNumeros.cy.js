...
const dataPrueba = require("./data/Numeros.json");
...
describe("Escenario para validar y verificar la creación y la publicación de un post en la aplicación ghost", () => {
    ...
    it("Primer caso: Crear, publicar y verificar post en Ghost Titulo que incluye caracteres especiales ...", () => {
        let indice = new Number();
        let indice2 = new Number();
        let indice3 = new Number();
        let indice4 = new Number();
        ...
        let nuevoTituloPost = new String(); // Declarar variable para almacenar el nuevo título del post
        let nuevoContenidoPost = new String(); // Declarar variable para almacenar el nuevo contenido del post
        ...
        console.log("Titulo del post: ", tituloPost);
        //contenido
        indice2 = getRandom(0, dataPrueba2.length);
        contenidoPost = dataPrueba2[indice2];
        contenidoPost = JSON.stringify(dataPrueba2[indice].title).replace(/"/g, '');
        ...
        indice3 = getRandom(0, dataPrueba.length);
        nuevoTituloPost = dataPrueba[indice];
        nuevoTituloPost = JSON.stringify(dataPrueba[indice].title);
        //contenido
        indice4 = getRandom(0, dataPrueba2.length);
        nuevoContenidoPost = dataPrueba2[indice2];
        nuevoContenidoPost = JSON.stringify(dataPrueba2[indice].title);
