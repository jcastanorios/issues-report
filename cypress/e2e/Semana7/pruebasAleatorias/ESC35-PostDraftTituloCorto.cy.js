...
describe('Escenario #18 - Crear un post, y verificar que este publicado en borrador', () => {
    beforeEach(()=>{
     ...
     it('ESC103-Crear un nuevo post con titulo corto, Verificar que este en la lista de borrador- Aletorio', () => {
        let titulo = faker.lorem.text(); // Generar un título aletorio
