...
describe("Escenario para validar y verificar la creación y la publicación de un page en la aplicación ghost", () => {
    ...
    it("Primer caso: Crear, publicar y verificar PAGE en Ghost con caracteres especiales ...", () => {
        let tituloPage = faker.internet.emoji();
        let contenidoPage = faker.lorem.words(500);
