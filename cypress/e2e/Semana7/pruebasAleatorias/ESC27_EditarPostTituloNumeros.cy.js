...
describe("Escenario para validar y verificar la creación y la publicación de un post en la aplicación ghost", () => {
    ...
    it("Primer caso: Crear, publicar y verificar post en Ghost Titulo que incluye caracteres especiales ...", () => {
        let tituloPost1 = faker.number.bigInt();
        let tituloPost = tituloPost1.toString();
        let contenidoPost = faker.lorem.words(100);
        ...
        let nuevoTituloPost1 = faker.number.bigInt();
        let nuevoTituloPost = nuevoTituloPost1.toString();
        let nuevoContenidoPost = faker.lorem.words(100);
