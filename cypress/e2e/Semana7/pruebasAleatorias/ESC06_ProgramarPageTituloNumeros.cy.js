...
describe("Escenario para validar y verificar la creación y la publicación de un page en la aplicación ghost", () => {
    ...
    it("Segundo caso: Crear página y programar su publicación Titulo con Numeros ...", () => {
        let tituloPage1 = faker.number.bigInt();
        let tituloPage = tituloPage1.toString();
        let contenidoPage = faker.lorem.paragraph();
