...
const dataPrueba1 = require("./data/caracteres_especiales.json");
const dataPrueba2 = require("./data/caracteres_especiales.json");
...
describe("Escenario para validar y verificar la creación y la publicación de un tag en la aplicación ghost", () => {
    ...
    it("Octavo caso: Crear tag con nombre que contiene emoticon en Ghost...", () => {
        ...
        slug = JSON.stringify(dataPrueba1[indice1].title).replace(/"/g, '');
        //descripcion
