...
describe("Escenario para validar y verificar la creación y la publicación de un post en la aplicación ghost", () => {
    ...
    it("Primer caso: Editar post en Ghost Titulo que incluye caracteres alfanumericos ...", () => {
        let tituloPost = faker.string.alphanumeric(100);
        let contenidoPost = faker.lorem.words(50);
        ...
        let nuevoTituloPost = faker.string.alphanumeric(100);
        let nuevoContenidoPost = faker.lorem.words(50);
